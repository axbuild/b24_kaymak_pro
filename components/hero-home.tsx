        ...
        <div className="py-12 md:py-20">
          ...
          <div className="pb-12 text-center md:pb-20">
            <h1
              ...
              data-aos="fade-up"
            >
              Внедрение и доработка CRM Битрикс
            </h1>
            <div className="mx-auto max-w-3xl">
              <p
                ...
                data-aos-delay={200}
              >
                Помогаем бизнесу расти и автоматизировать продажи — быстро, профессионально и по доступной цене.
              </p>
          ...
          <ModalVideo
            ...
            video="https://www.youtube.com/watch?v=CQN910sr5XE"
            videoWidth={1920}
            videoHeight={1080}
          />
        </div>
